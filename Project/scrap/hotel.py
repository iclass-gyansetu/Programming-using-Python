...
def scrap_hotel(all_data = {}):
    ...
    url_list = ['https://www.oyorooms.com/hotels-in-gurgaon/?filters%5Bcity_id%5D=1&filters%5Broom_pricing%5D%5Bmax%5D=6029&filters%5Broom_pricing%5D%5Bmin%5D=1946']
    
    filename = 'all_hotel.csv'
    name_list = []  
    price_list = []
    combined_list = []
    data_dict = {}
