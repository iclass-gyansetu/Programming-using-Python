...
def scrap_hotel(all_data = {}):
    
    url_list = ['https://www.oyorooms.com/search?location=Goa%2C%20India&city=Goa&searchType=city&coupon=&checkin=04%2F08%2F2019&checkout=05%2F08%2F2019&roomConfig%5B%5D=1&showSearchElements=false&guests=1&rooms=1&countryName=India&country=india&filters%5Bcity_id%5D=10']
    
    filename = 'goa_hotel.csv'
    name_list = []  
    price_list = []
    combined_list = []
    data_dict = {}
