...
def scrap_dlf(all_data = {}):
    
    url_list = ['https://www.oyorooms.com/search?checkin=04%2F08%2F2019&checkout=05%2F08%2F2019&city=undefined&country=india&coupon=&filters%5Bcoordinates%5D%5Blatitude%5D=28.471981&filters%5Bcoordinates%5D%5Blongitude%5D=77.104735&filters%5Broom_pricing%5D%5Bmax%5D=6029&filters%5Broom_pricing%5D%5Bmin%5D=2017&guests=1&latitude=28.471981&location=DLF+Phase+1%2C+Gurgaon%2C+Haryana&longitude=77.104735&roomConfig%5B%5D=1&rooms=1&searchType=locality&showSearchElements=false']
    
    filename = 'dlf_hotel.csv'
    name_list = []  
    price_list = []
    combined_list = []
    data_dict = {}
